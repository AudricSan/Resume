...
class LanguageLevelDAO extends Env
{
    ...
    public function __construct()
    {
        ...
        //
        $this->table = "resume_languagelevel"; // The table to attack
    ...
    {
        try {
            $statement = $this->connection->prepare("SELECT * FROM {$this->table} WHERE languageLevel_id = ?");
